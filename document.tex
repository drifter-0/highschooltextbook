...
% 数学版本
\newcommand{\abo}{%
	\definecolor{abcolor1}{RGB}{247,148,60} % A版封面
	\node[
	anchor=south east,
	inner sep=0pt,
	outer sep=0pt,
	...
	yshift=1.5cm
		...
		{\fontsize{60pt}{60pt}\selectfont A}%
		\hspace{-0.05em}%
		{\heit\fontsize{30pt}{30pt}\selectfont 版}%
	};
}
\newcommand{\abt}{%
	\definecolor{abcolor2}{RGB}{247,148,60} % A版扉页
	\node[
	anchor=south east,
	inner sep=0pt,
	outer sep=0pt,
...
\begin{document}
	...
	\begin{tikzpicture}[remember picture, overlay]
		...
		\begin{scope}[shift={(BackNW)}]
			...
			at ([shift={(0.7cm,-2cm)}]current page.north west) {\includegraphics[width=2cm]{rjs.png}}; % 人教社标志
...
%			\node[anchor=center, inner sep=0pt, outer sep=0pt, align=center, font=\zhongsong\fontsize{\SubjectFont pt}{\SubjectFont pt}\selectfont] at (mybox.center) {\SubjectInline};
			...
			\node[ anchor=south west, inner sep=0pt, outer sep=0pt] at (0, 0) {\includegraphics[width=6.35cm]{title.png}};
			...
			%\node at (circleCenter) {\includegraphics[width=3cm]{bz.png}};
			...
			\path[decoration={text along path, text={|\heavyfont\color{white}|\AuditText}, text align={fit to path}, raise=-2ex}, decorate] (circleCenter) ++(225:1.45cm) arc[start angle=225, end angle=-45, radius=1.45cm];
			\path[decoration={text along path, text={|\fzhteng|\YearText}, text align={fit to path}, raise=0.5ex}, decorate] (circleCenter) ++(245:1.45cm) arc[start angle=245, end angle=295, radius=1.45cm];
			
%			\coordinate (prizePos) at ($(circleCenter)+(3.5cm,0)$);
%			\node(prizeNode) at (prizePos) {\includegraphics[width=3cm]{prize.png}};
%			\node[below=0.2cm of prizeNode] {\heit\textcolor{\PrizeColor}{\PrizeText}};
	...
	\begin{tikzpicture}[remember picture, overlay]
		\begin{scope}[shift={(current page.north west)}]
			...
			inner sep=0pt,
			outer sep=0pt
			] at (15, -5.7) {\includegraphics[width=7cm]{title.png}};
			...
			\node[anchor=center] at (10.5cm, -26.5cm) {\includegraphics[width=5cm]{rjsblack.png}};
